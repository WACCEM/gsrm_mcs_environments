...
ROOT_DIR="/pscratch/sd/w/wcmca1/hackathon/mcs/nicam_gl11/"
TRACK_FILE="${ROOT_DIR}/stats/mcs_tracks_final_20200301.0000_20210301.0000.nc"
MASK_FILE="${ROOT_DIR}/mcstracking/nicam_hrly_mcsmask_hp8_v1.zarr"
OUTPUT_DIR="/pscratch/sd/p/paccini/temp/hackathon/updated_environmental_variables/NICAM_all/from_masks"
